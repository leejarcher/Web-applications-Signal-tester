/* web audio peak meter from
https://github.com/esonderegger
/web-audio-peak-meter/blob/master
/index.js  */
...
var webAudioPeakMeter = (function() {
  ...
  var createMeterNode = function(sourceNode, audioCtx) {
    ...
    meterNode = audioCtx.createScriptProcessor(2048, c, c);
    sourceNode.connect(meterNode);
    meterNode.connect(audioCtx.destination);
    return meterNode; 
  };
  
  // connect and disconnect methods added 
  // 22-11-17 by Lee Archer
  var connect = function(sourceNode) {
	sourceNode.connect(meterNode);
  };
	
  var disconnect = function(sourceNode) {
	sourceNode.disconnect(meterNode);
  };
  
  // reset method added 27/4/18
  var reset = function() {
